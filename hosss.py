...
con=sqlcon.connect(host="localhost",user="root",password=a)#connection to mysql 
cur=con.cursor()
...
root=Tk()
label=Label(root,text="VIVEKANANDA HOSPITAL",font="arial 40 bold",bg='light blue')
b1=Button(text="Registration",font="cambria 20 bold",bg='white',command=register)
b2=Button(text="Appointment",font="cambria 20 bold",bg='white',command=apoint)
b3=Button(text="List of Doctors",font="cambria 20 bold",bg='white',command=lst_doc)
b4=Button(text="Services available",font='cambria 20 bold',bg='white',command=ser_avail)
b5=Button(text="Modify existing data",font='cambria 20 bold',bg='white',command=mod_sub)
b6=Button(text="Exit",font='cambria 20 bold',command=root.destroy,bg='red')
label.pack()
...
frame=Frame(root,height=600,width=0)
frame.pack()
root.resizable(False,False)
root.mainloop()
